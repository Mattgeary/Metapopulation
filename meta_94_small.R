...
map <- raster("maxent_large.asc", crs=BNG)
...
write.csv(meta.94_pop, "P94_pop_small.csv", row.names=F)
write.csv(meta.94_lek.size, "P94_1_lek_size_small.csv", row.names=F)
write.csv(meta.94_n.leks, "P94_1_leks_small.csv", row.names=F)
save.image("P94_small.RData")
