...
gc()
env.l.new <- stack(raster(paste(getwd(), "Proportion/hab_1.asc", sep="/"), crs=BNG), raster(paste(getwd(), paste("Scenario_7/run_", j, sep=""), "hab_2.asc", sep="/"), crs=BNG), raster(paste(getwd(), paste("Scenario_7/run_", j, sep=""), "hab_3.asc", sep="/"), crs=BNG), raster(paste(getwd(), paste("Scenario_7/run_", j, sep=""), "hab_4.asc", sep="/"), crs=BNG), raster(paste(getwd(), "Proportion/hab_5.asc", sep="/"), crs=BNG), raster(paste(getwd(), "Proportion/hab_6.asc", sep="/"), crs=BNG), raster("studyareadem.asc", crs=BNG))
