...
source("Map_create_scenario_1.R", echo=T, verbose=T)

source("Map_create_scenario_2.R", echo=T, verbose=T)

source("Map_create_scenario_3.R", echo=T, verbose=T)

source("Map_create_scenario_6.R", echo=T, verbose=T)

source("Map_create_scenario_7.R", echo=T, verbose=T)
