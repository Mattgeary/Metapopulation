...
map <- raster(paste("s6_map_",sm, ".asc", sep=""), crs=BNG)
...
write.csv(meta.s6_pop, "Scenario_1_pop.csv")
write.csv(meta.s6_lek.size, "Scenario_1_lek_size.csv")
write.csv(meta.s6_n.leks, "Scenario_1_leks.csv")
