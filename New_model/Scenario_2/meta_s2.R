...
map <- raster(paste("s2_map_",sm, ".asc", sep=""), crs=BNG)
...
write.csv(meta.s2_pop, "Scenario_2_pop.csv")
write.csv(meta.s2_lek.size, "Scenario_2_lek_size.csv")
write.csv(meta.s2_n.leks, "Scenario_2_leks.csv")
