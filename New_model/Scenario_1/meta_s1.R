...
map <- raster(paste("s1_map_",sm, ".asc", sep=""), crs=BNG)
...
write.csv(meta.s1_pop, "Scenario_1_pop.csv")
write.csv(meta.s1_lek.size, "Scenario_1_lek_size.csv")
write.csv(meta.s1_n.leks, "Scenario_1_leks.csv")
